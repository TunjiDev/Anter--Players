    ...
    <div className="profile__user">
        ...
        <div className="profile__user-details">
            <div className="profile__user-details__img">
                ...
                <button className="icon-container"onClick={()=>{history.push('/chooseusername')}}>
                  <Link to='/chooseusername'><img src={pencil} alt="pencil pic" /></Link>  
                </button>
            </div>
            <div className="profile__user-details__other-details">
                ...
                <div className="profile__user-details__other-details__total-earned">
                    ...
                    <div className="flex">
                        <span><img src={yellowCoin} alt=""/></span>&nbsp;
        ...
        <div className="profile__user__refer">
            ...
            <p className="invite-text">
                Enter your code to get a free reward that will help you win live trivia..
            </p>
            <form action="" className="referral-code">
                <input type="text" className="referral-input" placeholder="Enter refferal code"/>
                <input className="btn referral-btn" type="button" value="Submit"/>
            </form>
        </div>
    </div>
    <div className="profile__opt-btns">
        <button className="btn profile-btn">Withdraw</button>
        <button className="btn profile-btn">How it Works</button>
